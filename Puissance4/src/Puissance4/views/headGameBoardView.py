...
class HeadGameBoard(toga.Box):
    def __init__(self):
        ...
        labelNamePlayer1 = toga.Label(text=namePlayer1,style=(Pack(padding=3,font_size=15,text_align=CENTER,font_weight="bold", alignment=CENTER,flex=1)))
        self.labelScorePlayer1 = toga.Label(text="0",style=(Pack(padding=3,font_size=15,text_align=CENTER,font_weight="bold", alignment=CENTER,flex=1,width=50)))
        ...
        labelNamePlayer2 = toga.Label(text=namePlayer2, style=(Pack(padding=3, font_size=15, text_align=CENTER, font_weight="bold", alignment=CENTER, flex=1)))
        self.labelScorePlayer2 = toga.Label(text="0", style=(Pack(padding=3, font_size=15, text_align=CENTER, font_weight="bold", alignment=CENTER, flex=1, width=50)))
